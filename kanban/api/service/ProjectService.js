...
class ProjectService {
    ...
    static async createProject(payload) {
        try {
            const createdProject = await TransactionHandler.run(async () => {
    ...
    static async updateProject(payload) {
        try {
            const updatedProject = await TransactionHandler.run(async () => {
    ...
    static async removeProject(payload) {
        try {
            const removedProject = await TransactionHandler.run(async () => {
                const projectId = payload.project_id
